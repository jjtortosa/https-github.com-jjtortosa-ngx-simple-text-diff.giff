...
NgxSimpleTextDiffComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NgxSimpleTextDiffComponent, selectors: [["lib-ngx-simple-text-diff"]], inputs: { oldText: "oldText", newText: "newText" }, decls: 1, vars: 1, consts: [[3, "ngClass", 4, "ngFor", "ngForOf"], [3, "ngClass"]], template: function NgxSimpleTextDiffComponent_Template(rf, ctx) { if (rf & 1) {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 17, vars: 5, consts: [[3, "oldText", "newText"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
